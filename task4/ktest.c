...
#define ADC12 0b00100100
#define ADC13 0b00100101
#define RS 0
#define RW 1
#define EN 2
...
unsigned char lsharp=0;
unsigned char rsharp=0;
...
int main()
{
	...
	while(1)
	{
		...
		//bit0(lvalue);
		//lcd_wr_char("/n");
	left=Sharp_conversion(lvalue);
	//bit0(lvalue);
		lcd_print(1,1,left,5);
