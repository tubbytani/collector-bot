...
void zap()
{ if ( ((final_array==5)&&((final_array++)==15))||((final_array==15)&&((final_array++)==5)))
	{
	...
	if ( ((final_array==7)&&((final_array++)==13))||((final_array==13)&&((final_array++)==7)))
	{
		int lsharp,lvalue,rvalue,rsharp;
		lvalue=ADC_Conversion(11);
		rvalue=ADC_Conversion(12);
...
void bam(void)
{   int lsharp,lvalue,rvalue,rsharp;
	while counter!=final_array[]
	{
		fwd();
	}
	if counter==final_array[]
	{   lvalue=ADC_Conversion(11);
		rvalue=ADC_Conversion(12);
		lsharp=Sharp_conversion(lvalue);
		rsharp=Sharp_conversion(rvalue);
